...
import { LINK_PRIVACY, TERMS_SUBTITLE, TERMS_TITLE } from '../../../constants';

import './_terms.scss';

const Terms = ({ reset, setTitle }) => {
	const title = TERMS_TITLE;
	...
	return (
		<div className="page terms">
			<Construction
				className="terms__under-construction"
				subtitle={TERMS_SUBTITLE}
				title={TERMS_TITLE}
			>
				<span className="terms__title">Overview</span>
				<p className="terms__text">
          This website is operated by Huang Lie Jun. Throughout the site, the
          terms “we”, “us” and “our” refer to Huang Lie Jun. Huang Lie Jun
          ...
          , and utilises API services including but not limited to those from{' '}
					<a
						className="terms__text-link"
          ...
          and{' '}
					<a
						className="terms__text-link"
						href="https://openexchangerates.org/about"
						rel="noopener noreferrer"
						target="_blank"
					>
            Open Exchange Rates
					</a>
          . These platforms and service providers equip us with the necessary
          tools and services to serve features and functionalities on our site
          to you.
				</p>
				<br />
				<span className="terms__title">Section 1 - General Conditions</span>
				<p className="terms__text">
          ...
          Section 2 - Accuracy, Completeness and Timeliness of Information
				...
				<p className="terms__text">
          Information made available on this site are subjected to availability
          with third-party API services such as Etherscan and OpenExchangeRates.
          They might also be subjected to rate-limitation and session
          authorisation due to our gateway API constraints. We are not
          ...
          suspension or discontinuance of the Service.
				...
				<br />
				<span className="terms__title">Section 4 - Optional Tools</span>
				<p className="terms__text">
          ...
          also be subject to these Terms of Service.
				...
				<br />
				<span className="terms__title">Section 5 - Third-Party Links</span>
				<p className="terms__text">
          ...
          policies and practices of third-parties and make sure you understand
          ...
          directed to the third-party.
				...
				<br />
				<span className="terms__title">
          Section 6 - User Comments, Feedbacks And Other Submissions
				</span>
				<p className="terms__text">
          ...
          or any third-party.
				...
				<br />
				<span className="terms__title">Section 7 - Personal Information</span>
				<p className="terms__text">
          Your submission of personal information through the store is governed
          by our Privacy Policy. For more information, please view our{' '}
					<Link
						className="terms__text-link"
						to={LINK_PRIVACY}
						rel="noopener noreferrer"
          ...
          notice. We undertake no obligation to update, amend or clarify
          information in the Service or on any related website except as
          ...
          modified or updated.
				...
				<br />
				<span className="terms__title">Section 9 - Prohibited Uses</span>
				<p className="terms__text">
          ...
          title, and non-infringement. In no case shall Huang Lie Jun be liable
          ...
          using the service, or for any other claim related in any way to your
          use of the service or any product, including, but not limited to, any
          ...
          permitted by law.
				...
				<br />
				<span className="terms__title">Section 11 - Indemnification</span>
				<p className="terms__text">
          You agree to indemnify, defend and hold harmless Huang Lie Jun from
          ...
          violation of any law or the rights of a third-party.
				...
				<br />
				<span className="terms__title">Section 12 - Severability</span>
				<p className="terms__text">
          ...
          provisions.
				...
				<br />
				<span className="terms__title">Section 13 - Termination</span>
				<p className="terms__text">
          ...
          accordingly may deny you access to our Services (or any part thereof).
				...
				<br />
				<span className="terms__title">Section 14 - Entire Agreement</span>
				<p className="terms__text">
          ...
          party.
				...
				<br />
				<span className="terms__title">Section 15 - Governing Law</span>
				<p className="terms__text">
          ...
          changes.
				...
				<br />
				<span className="terms__title">Section 17 - Contact Information</span>
				<p className="terms__text">
